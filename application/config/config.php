...
if($_SERVER['HTTP_HOST'] == 'lakita.com.vn')
	header('Location: https://lakita.vn/');

$config['base_url'] =  ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ?  "https" : "http");
$config['base_url'] .=  "://".$_SERVER['HTTP_HOST'];
$config['base_url'] .=  str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);
define('UPLOAD', realpath(dirname(dirname(dirname(__FILE__)))).'/');
//$config['allow_get_array'] = true;
//define('WEBSITE', 'http://trithucsong.com');
...
|
*/
$config['encryption_key'] = 'lkoihbMM|\nvghkdf@!$%hgghg645';
